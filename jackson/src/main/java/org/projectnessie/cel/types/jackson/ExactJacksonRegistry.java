...
final class ExactJacksonRegistry
    implements TypeRegistry,
        StandardScalarTypeAdapter,
        ExactAggregateTypeAdapter,
        ExactAggregateFieldProvider {
  private final JacksonRegistry delegate;

  ExactJacksonRegistry(JacksonRegistry delegate) {
    this.delegate = Objects.requireNonNull(delegate, "delegate");
  }

  @Override
  public TypeRegistry copy() {
    return new ExactJacksonRegistry((JacksonRegistry) delegate.copy());
  }
