...
public enum InterpreterTestCase {
  ...
  elem_in_mixed_type_list2,
  eq_bool_not_null,
  eq_list_elem_mixed_types_one_element,
  eq_list_elem_one_element,
  eq_list_elem_mixed_types_error,
  eq_list_mixed_type_numbers,
  eq_proto_different_types,
  eq_proto_nan_equal,
  in_list,
  in_map,
  index,
