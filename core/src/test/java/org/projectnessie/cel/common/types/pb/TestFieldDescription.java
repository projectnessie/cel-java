...
import google.expr.proto3.test.TestAllTypesOuterClass.TestAllTypes.NestedEnum;
...
public class TestFieldDescription {
  ...
  void fieldDescription() {
    ...
    Type wanted = Type.newBuilder().setMessageType("google.expr.proto3.test.TestAllTypes").build();
  ...
  static GetFromTestCase[] getFromTestCases() {
    return new GetFromTestCase[] {
      new GetFromTestCase().field("single_uint64").want(12L),
      ...
      new GetFromTestCase().field("single_int64_wrapper").want(0L), // unset
      new GetFromTestCase()
