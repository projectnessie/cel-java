...
public abstract class TestList<CONSTRUCT> {
  ...
  public static class TestStringArrayList extends TestList<String[]> {
    @Override
  ...
  public static class TestGenericArrayList extends TestList<Object[]> {
    @Override
  ...
  Lister checkList(TestData<CONSTRUCT> tc, Val listVal) {
    ...
    assertThat(list.contains(intOf(987654321))).isSameAs(False);
    assertThat(list.contains(stringOf("this-is-not-in-the-list"))).isSameAs(False);
