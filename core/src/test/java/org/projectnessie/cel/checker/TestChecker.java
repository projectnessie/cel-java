...
import static org.projectnessie.cel.checker.Env.newEnv;
...
public class TestChecker {
  ...
  static class TestCase {
    ...
    TestCase disableStdEnv(boolean disableStdEnv) {
      this.disableStdEnv = disableStdEnv;
      return this;
    }

    TestCase homogeneousAggregateLiterals(boolean homogeneousAggregateLiterals) {
      this.homogeneousAggregateLiterals = homogeneousAggregateLiterals;
      return this;
    }
  }
  ...
  static TestCase[] checkTestCases() {
    return new TestCase[] {
      ...
      new TestCase()
          ...
          .env(
              new env()
                  .idents(
                      Decls.newVar(
                          "x", Decls.newObjectType("google.expr.proto3.test.Proto2Message"))))
          .error(
      ...
      new TestCase()
          ...
          .env(
              new env()
                  .idents(
                      Decls.newVar(
                          "x", Decls.newObjectType("google.expr.proto3.test.TestAllTypes"))))
          .r(
              "_==_(\n"
                  + "\t\t\t_+_(\n"
      ...
      new TestCase()
          ...
          .container("google.expr.proto3.test")
          .r(
              "_!=_(google.expr.proto3.test.TestAllTypes.NestedEnum.BAR\n"
      ...
      new TestCase()
          ...
          .r(
              "google.expr.proto3.test.TestAllTypes\n"
                  ...
                  + "\t^google.expr.proto3.test.TestAllTypes")
          .type(Decls.newTypeType(Decls.newObjectType("google.expr.proto3.test.TestAllTypes"))),
      new TestCase()
          .i("test.TestAllTypes")
      ...
      new TestCase()
          ...
          .env(
              new env()
                  .idents(
                      Decls.newVar(
                          "pb2", Decls.newObjectType("google.expr.proto2.test.TestAllTypes")),
                      Decls.newVar(
      ...
      new TestCase()
          ...
          .type(
              Decls.newListType(
                  Decls.newObjectType("google.expr.proto2.test.TestAllTypes.NestedMessage"))),
      new TestCase()
          .i("TestAllTypes{}.repeated_nested_message")
          .container("google.expr.proto3.test")
          .r(
  ...
  void check(TestCase tc) {
    ...
    TypeRegistry reg =
        ProtoTypeRegistry.newRegistry(
            ...
            google.expr.proto3.test.TestAllTypesOuterClass.TestAllTypes.getDefaultInstance());
