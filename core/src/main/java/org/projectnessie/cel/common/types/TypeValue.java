...
public class TypeValue implements Type, Val {
  /** TypeType is the type of a TypeValue. */
  public static final TypeValue TypeType = newTypeValue("type");

  private final String name;
  private final EnumSet<Trait> traitMask;

  private TypeValue(String name, Trait... traits) {
  ...
  public static TypeValue newTypeValue(String name, Trait... traits) {
    return new TypeValue(name, traits);
  }
   ...
   */
  public static TypeValue newObjectTypeValue(String name) {
