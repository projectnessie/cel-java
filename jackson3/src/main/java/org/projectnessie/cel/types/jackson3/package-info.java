...
/**
 * Jackson 3 integration for exposing Java application objects to CEL.
 *
 * <p>This package belongs to the {@code cel-jackson3} artifact. Create a {@link
 * org.projectnessie.cel.types.jackson3.Jackson3Registry} when inputs are modeled by Jackson 3. The
 * separate {@code cel-jackson} artifact serves Jackson 2 applications; applications normally need
